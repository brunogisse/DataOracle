...
begin
  if Key = #13 then
  begin
      dateEmissaoNF.SetFocus;
      Key := #0;
  end;
end;

procedure TfrmVendaPostos.editOrdemCarregamentoKeyPress(Sender: TObject;
  var Key: Char);
begin
   if Key = #13 then
   begin
      editMotorista.SetFocus;
      Key := #0;
   end;
end;
...
procedure TfrmVendaPostos.editValorCombustivelKeyPress(Sender: TObject;
  var Key: Char);
begin
   if Key = #13 then
   begin
