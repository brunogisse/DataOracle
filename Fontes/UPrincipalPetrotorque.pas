...
begin
   ...
   // função ShellExecute para iniciar novamente o executável
...
begin
   ...
   begin
      if MessageBox(Application.Handle,
        'Olá!' + #13 + 'Deseja realmente iniciar o tracing? ' + #13 +
        'Caso escolha sim, o DataOracle será reiniciado', 'Confirmação',
   ...
   begin
      MessageDlg('O DataOracle será reiniciado para aplicar as configurações',
